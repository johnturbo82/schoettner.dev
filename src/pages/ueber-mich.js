...
const AboutPage = () => {
    return (
        <Layout sitetitle="Über mich" path="/ueber-mich">
            ...
            <ul>
                <li><a onClick={() => scrollTo('#entwicklung')}>Entwicklung</a></li>
                <li><a onClick={() => scrollTo('#motorradfahren')}>Motorradfahren</a></li>
                <li><a onClick={() => scrollTo('#musik')}>Musik und Konzerte</a></li>
            </ul>
