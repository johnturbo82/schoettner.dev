...
`
    ...
    return (
        <Layout sitetitle="Projekt Qivi" path="/projekte/qivi" parent="Projekte">
            ...
            <ContentImage src={data.qivi_mobile_home.childImageSharp.gatsbyImageData} description="Screenshot der Startseite" orientation="right" />
            ...
            <ContentImage src={data.qivi_desktop_terminal_neue_anfrage.childImageSharp.gatsbyImageData} description="Terminal - neue Anfrage" />
            ...
            <div className="flex-container">
                <ContentImage src={data.qivi_mobile_home_scroll.childImageSharp.gatsbyImageData} description="Startseite mobile Ansicht" orientation="inline" />
                <ContentImage src={data.qivi_mobile_leistungen.childImageSharp.gatsbyImageData} description="Seite: Leistungen" orientation="inline" />
                <ContentImage src={data.qivi_mobile_terminal_start.childImageSharp.gatsbyImageData} description="Terminal - Einstiegsseite" orientation="inline" />
            </div>
