    ...
    return (
        <Layout sitetitle="Startseite" path="/">
            <div className="left right_sidebar_opposite">
                ...
                <p>Bei meinem letzten Arbeitgeber BFFT Gesellschaft für Fahrzeugtechnik mbH, jetzt EDAG Engineering GmbH, habe ich viel noch viel <em>PHP </em> und <em>C#</em> gemacht. Das waren noch Zeiten...</p>
                ...
                <p>Diese Seite gibt's nur, weil viele die Domain meiner Email-Adresse in den Browser tippen und dann enttäuscht sind, dass es keinen Inhalt gibt. Solltest Du auch auf diesem Wege zu mir gekommen sein: <em>Hallo!</em></p>
            </div>
            <Passion />
        </Layout>
    )
